...
storiesOf("Switch", module)
	...
	.add("default", () => <Switcher disabled={boolean("Diabled", false)} />)
	.add("with ThumbColor", () => (
		<Switcher thumbColor={color("Thumb Color", "#000")} />
	))
	.add("with ios_backgroundColor", () => (
		<Switcher ios_backgroundColor={color("iOS Background Color", "#000")} />
	))
	.add("with track color", () => (
		<Switcher trackColor={color("Track Color", "#000")} />
	));
